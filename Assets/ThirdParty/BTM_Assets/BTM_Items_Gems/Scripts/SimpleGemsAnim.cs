...
namespace Benjathemaker
{
    public class SimpleGemsAnim : MonoBehaviour
    {
        ...
        {
            target_ = target;
            initialScale = target_.transform.localScale;
            initialPosition = target_.transform.position;
        ...
        public void UpdateRot()
        {
            if (isRotating)
            {
                ...
                target_.transform.Rotate(rotationVector * rotationSpeed * Time.deltaTime);
            }
        ...
        public void UpdateScale()
        {
            if (isScaling)
            {
                ...
                target_.transform.localScale = Vector3.Lerp(startScale, endScale, t);
            }
        }
